...
export const FONTS = {
    ...
    h2: { fontFamily: "Poppins-Semibold", fontSize: SIZES.h2, fontWeight:'bold'},
    h3: { fontFamily: "Poppins-Semibold", fontSize: SIZES.h3, fontWeight:'bold'},
    h4: { fontFamily: "Poppins-Semibold", fontSize: SIZES.h4, fontWeight:'bold'},
    h5: { fontFamily: "Poppins-Semibold", fontSize: SIZES.h5, fontWeight:'bold'},
